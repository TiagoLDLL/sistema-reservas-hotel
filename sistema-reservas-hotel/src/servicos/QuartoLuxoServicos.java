...
public class QuartoLuxoServicos {
    ...
    public void add(){
        ...
        repositorio.add(new QuartoLuxo(preco, andar, hotel, numeroQuarto, status, jacuzzi, servicoDeQuarto));
    ...
    public void update(){
        ...
        while(true){
            ...
            if(opcaoQuarto > 0 && opcaoQuarto <= repositorio.size()){
                ...
                System.out.println("\n[5] Status  [6] Jacuzzi   [7] Serviço de Quarto [8] Tudo");
                System.out.print("\nSelecione a opção: ");
                while(true){
                    ...
                    switch(opcaoMod){
                        ...
                        QuartoLuxo newQuartoLuxo = new QuartoLuxo(preco, andar, hotel, numeroQuarto, status, jacuzzi, servicoDeQuarto);
    ...
    public void getInfo(){
        ...
        while(true){
            ...
            if(opcaoInfo < 1 || opcaoInfo > repositorio.size()){
                ...
                System.out.println("Jacuzzi: "+repositorio.get(opcaoInfo).getJacuzzi());
                System.out.println("Serviço de Quarto: "+repositorio.get(opcaoInfo).getServicoDeQuarto());
