...
import repositorio.QuartoSimplesRepositorio;

public class QuartoSimplesServico {
    
    InputManager inputManager = new InputManager();
    QuartoSimplesRepositorio repositorio = new QuartoSimplesRepositorio();
    ...
    public void add(){
        ...
        double tamanhoVentilador;

        if(ventiladorDeTeto){
            System.out.print("\nInsira o tamanho do ventilador: ");
            tamanhoVentilador = inputManager.getDouble();
        } else {
            tamanhoVentilador = 0;
        }
        ...
        repositorio.add(new QuartoSimples(preco, andar, hotel, numeroQuarto, status, geladeira, ventiladorDeTeto, tamanhoVentilador));
        System.out.print("\nQuarto adicionado com sucesso.");
    }

    //AKA: buscarQuartoViaTamanhoDoVentiladorDeTeto.
    public void bQVTDVDT(){
        System.out.print("\nDigite o tamanho do ventilador: ");
        double tamanhoVentilador = inputManager.getDouble();
        QuartoSimples quarto = repositorio.buscarViaTamanhoVentilador(tamanhoVentilador);
        if(quarto==null){
            System.out.println("\nNão foi encontrado um quarto com esse ventilador.");
            return;
        }
        System.out.println("\n===== ===== Quarto encontrado! ===== =====");
        ...
        System.out.println("Ventilador de teto: "+quarto.getTamanhoVentilador()+" de Tamanho.");
        if(quarto.getGeladeira()){
            System.out.println("Geladeira Incluída.");
        }
    ...
    public void update(){
        ...
        while(true){
            ...
            if(opcaoQuarto > 0 && opcaoQuarto <= repositorio.size()){
                ...
                System.out.println("\n[5] Status  [6] Geladeira [7] Ventilador [8] Tamanho do Ventilador");
                ...
                while(true){
                    ...
                    switch(opcaoMod){
                        ...
                        //===== ===== ===== ===== =====
                        case 8:
                        if(!repositorio.get(opcaoQuarto-1).getVentiladorDeTeto()){
                            System.out.println("\nEste quarto não possuí ventilador de teto.");
                            return;
                        }
                        System.out.print("Insira o tamanho do ventilador: ");
                        double newTamanhoVentilador = inputManager.getDouble();
                        repositorio.get(opcaoQuarto-1).setTamanhoVentilador(newTamanhoVentilador);
                        System.out.print("\nQuarto modificado com sucesso.");
                        return;
                        //===== ===== ===== ===== =====
                        case 9:
                        ...
                        QuartoSimples newQuartoSimples = new QuartoSimples(preco, andar, hotel, numeroQuarto, status, geladeira, ventiladorDeTeto, tamanhoVentilador);
